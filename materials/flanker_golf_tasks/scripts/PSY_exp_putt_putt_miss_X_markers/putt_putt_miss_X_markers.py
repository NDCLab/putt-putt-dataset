...
expName = 'Sarah'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\NDClab\\Desktop\\Sarah_exp_2_Golf_X_markers\\Sarah.py',
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if begin_text1.status == STARTED and not pulse_started:
            port.write([0x01]) #sends "S1" as a stimulus trigger!
